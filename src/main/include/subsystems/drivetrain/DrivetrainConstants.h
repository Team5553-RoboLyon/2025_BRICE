...
namespace driveConstants 
{
    ...
    namespace Motors
    {
        ...
        constexpr int CURRENT_LIMIT = 40;
        constexpr double RAMP_RATE = 0.0; //TUNEME
        constexpr double VOLTAGE_COMPENSATION = 6.0;
        constexpr int HOT_THRESHOLD = 60; //TUNEME
        constexpr int OVERHEATING_THRESHOLD = 75; //TUNEME
    }
    ...
    namespace ArcadeDrive
    {
        ...
        constexpr double MAX_ROTATION_SIGMA = 0.25; //TUNEME

        constexpr double TIME_TO_REACH_FULL_FORWARD = 1.2; //TUNEME
        constexpr double TIME_TO_REACH_FULL_ROTATION = 0.8; //TUNEME

        constexpr double TIME_TO_STOP_FORWARD = 0.6; //TUNEME
        constexpr double TIME_TO_STOP_ROTATION = 0.3; //TUNEME
    }
