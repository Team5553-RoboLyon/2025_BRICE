...
void Elevator::Test(double value) {
  ...
  //test 2
  // m_pid.SetSetpoint(-0.3);
  // frc::SmartDashboard::SmartDashboard::PutNumber("pid pas bien",m_pid.Calculate(GetHeight()) );
  ...
  //test 4
  // m_pid.SetSetpoint(10);
  // setSpeed(m_pid.Calculate(value));

  //test 5
  // m_pid.SetSetpoint(10);
  // setSpeed(m_pid.Calculate(10));

  //test 6
  // m_pid.SetSetpoint(10);
  // setSpeed(m_pid.Calculate(0)); 
}
